...
android {
    ...
    // Android 16 is API 36. Keep the local build reproducible with the installed SDK.
    compileSdk = 36
    compileSdkMinor = 1
    ...
    buildTypes {
        ...
        create("nonMinifiedRelease") {
            ...
            // Local MVP delivery: keep the release build type but use the
            // Android debug key because no private release keystore is supplied.
...
base {
    archivesName = "本地听歌-${android.defaultConfig.versionName}${android.defaultConfig.versionNameSuffix ?: ""}"
}
...
dependencies {
    ...
    // alpha32 requires API 36.1; alpha31 is the latest installed SDK 36-compatible release.
